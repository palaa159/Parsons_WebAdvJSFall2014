...
// this makes the heart colored on click

$(".heart").click( function() {
          $(".heart, .heart ").css("color", "#c2c0c0");
          $(this).css("color", "#cc3399");
           localStorage.pullquote = JSON.stringify(pullquote.fav);
        localStorage.setItem('pullquote', pullquote);
        });

// this is for the favorites tab
...
$( ".highlight" ).html( '<p>Oblique Catagies combines <a href="http://en.wikipedia.org/wiki/Oblique_Strategies">Oblique Strategies</a> by Brian Eno and Peter Schmidt with pictures of cats to hilarious, useful ends. It was created by <a href="http://nikiselken.com">Niki Selken</a></p>' );
  });

// function pullquote to get quote on screen

var pullquote= $('.highlight') .append(quote[Math.floor( Math.random() * 464 )]);

//local storage

localStorage.pullquote = JSON.stringify(pullquote);

// later that evening…
localStorage.setItem('pullquote', pullquote);

var names = localStorage.getItem('pullquote');
